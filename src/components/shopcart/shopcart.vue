                    ...
                    <div class="list-content" ref="list-content">
                        <ul>
                            <li class="food" v-for="(food, index) in selectFoods" :key="index">
                                ...
                                <div class="price">
                                    <span><span class="fee">￥</span>{{food.price*food.count}}</span>
                                </div>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            /* 将data中定义的balls，新添加一个元素属性（这个元素来自goods el），并把这些ball放到数组dropBalls中 */
            drop(el) {
            ...
            /* 通过两层来实现抛物线小球：外层ball控制y轴的位置，内层inner控制x轴的位置，通过css样式的cubizier曲线实现抛物线，注意书写正确，曾经犯过的错误 */
            beforeEnter(el) {
